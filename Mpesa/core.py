...
class MpesaClient:
    ...
    def stk_push(
        self, phone_number, amount, account_reference, transaction_desc, callback_url
    ):
        ...
        business_short_code = (
            mpesa_config("MPESA_EXPRESS_SHORTCODE")
            if mpesa_environment == "sandbox"
            else mpesa_config("MPESA_SHORTCODE")
        )
    ...
    def business_payment(
        self, phone_number, amount, transaction_desc, callback_url, occassion
    ):
        command_id = "BusinessPayment"
        return self.b2c_payment(
            phone_number, amount, transaction_desc, callback_url, occassion, command_id
        )
